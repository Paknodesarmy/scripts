...
# 0G Storage Node Auto-Installation Script
...
echo -e "\e[1m\e[32m5. Downloading and building the binary... \e[0m" && sleep 1
cd $HOME
...
# Wallet private key check
echo -e "\e[1m\e[32m6. Wallet private key check... \e[0m" && sleep 1
...
# Create service
echo -e "\e[1m\e[32m8. Creating service... \e[0m" && sleep 1
